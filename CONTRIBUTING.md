...
1. Make an [Issue](https://github.com/ligofff/lgf-unity-naming-case-changer/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-unity-naming-case-changer": "https://github.com/YOUR_USER/lgf-unity-naming-case-changer.git"
        }
    }
```
